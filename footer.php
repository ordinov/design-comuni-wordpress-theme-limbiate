...
<footer class="it-footer" id="footer">
    <div class="it-footer-main">
        ...
        <div class="container">
            ...
            <?php if (is_active_sidebar('limbiate-footer-area')) : ?>
                <div class="row">
                    <div class="col-12 footer-items-wrapper logo-wrapper">
                        <div id="footer-widget-area" class="footer-widget-area widget-area limbiate-widget-area-container" role="complementary">
                            <?php dynamic_sidebar('limbiate-footer-area'); ?>
                        </div>
                    </div>
                </div>
                <hr>
