...
function dci_register_pagina_eventi_options(){
    ...
    $eventi_options->add_field( array(
        ...
        'desc' => __( 'Configurazione del calendario Eventi. Aggiungere una pagina "Eventi" impostando come template "Eventi".' , 'design_comuni_italia' ),
        'type' => 'title',
    ) );
    $eventi_options->add_field( array(
        'id' => $prefix . 'immagine',
    ...
    $eventi_options->add_field( array(
        'id' => $prefix . 'breadcrumb_vivere',
        'name'        => __( 'Sostituisci a "Vivere il Comune"', 'design_comuni_italia' ),
        'desc' => __( 'Sostituisci "Eventi" a "Vivere il Comune" nel breadcrumb' , 'design_comuni_italia' ),
        'type' => 'checkbox',
    ) );
    $eventi_options->add_field( array(
        'id' => $prefix . 'calendar',
        'name'        => __( 'Calendario', 'design_comuni_italia' ),
        'desc' => __( 'Abilita il calendario invece della lista eventi' , 'design_comuni_italia' ),
        'type' => 'checkbox',
    ) );
    $eventi_options->add_field( array(
        'id' => $prefix . 'valuta_servizio',
        'name'        => __( 'Valuta Servizio', 'design_comuni_italia' ),
        'desc' => __( 'Abilita la sezione "Valuta il servizio"' , 'design_comuni_italia' ),
        'type' => 'checkbox',
    ) );
    $eventi_options->add_field( array(
        'id' => $prefix . 'assistenza_contatti',
        'name'        => __( 'Assistenza e contatti', 'design_comuni_italia' ),
        'desc' => __( 'Abilita la sezione "Assistenza e contatti"' , 'design_comuni_italia' ),
        'type' => 'checkbox',
    ) );
    // $eventi_options->add_field( array(
